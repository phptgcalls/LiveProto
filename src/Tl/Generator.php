...
abstract class Generator {
	...
	static private function cleanFiles() : void {
		if(isDirectory(__DIR__.DIRECTORY_SEPARATOR.'Types')) self::deleteFolder(__DIR__.DIRECTORY_SEPARATOR.'Types');
		if(isDirectory(__DIR__.DIRECTORY_SEPARATOR.'Functions')) self::deleteFolder(__DIR__.DIRECTORY_SEPARATOR.'Functions');
	}
	static private function create(array | string ...$tls) : void {
		self::cleanFiles();
		createDirectoryRecursively(__DIR__.DIRECTORY_SEPARATOR.'Types');
		createDirectoryRecursively(__DIR__.DIRECTORY_SEPARATOR.'Functions');
		$filename = __DIR__.DIRECTORY_SEPARATOR.'All.php';
		...
		foreach($result as $space => $methods):
			$folder = __DIR__.DIRECTORY_SEPARATOR.('Functions').DIRECTORY_SEPARATOR.$space;
		...
		foreach($result as $space => $constructors):
			$folder = __DIR__.DIRECTORY_SEPARATOR.('Types').DIRECTORY_SEPARATOR.$space;
			createDirectoryRecursively($folder);
